...
/* [LX] Functions provided by the library have to be determined
        before compilation. A #define switch like this not possible */
/*
** {==================================================================
...
static int lx_open (lua_State *L) {
    /* Registers random functions with upvalue directly in module table */
    setrandfunc(L);
    return 0;
}
